...
inline auto VECTOR_GREATER_THAN(const VecType& op1, const VecType& op2, size_t vl) {
    if constexpr (std::is_same_v<T, int8_t>) {
        if constexpr (LMUL == M1) return __riscv_vmsgt_vv_i8m1_b8(op1, op2, vl);
        ...
        if constexpr (LMUL == M1) return __riscv_vmsgt_vv_i16m1_b16(op1, op2, vl);
        ...
        if constexpr (LMUL == M1) return __riscv_vmsgt_vv_i32m1_b32(op1, op2, vl);
...
inline auto VECTOR_GREATER_THAN_SCALAR(const VecType& op1, T scalar, size_t vl) {
    if constexpr (std::is_same_v<T, int8_t>) {
        if constexpr (LMUL == M1) return __riscv_vmsgt_vx_i8m1_b8(op1, scalar, vl);
        ...
        if constexpr (LMUL == M1) return __riscv_vmsgt_vx_i16m1_b16(op1, scalar, vl);
        ...
        if constexpr (LMUL == M1) return __riscv_vmsgt_vx_i32m1_b32(op1, scalar, vl);

...
print(f"\nGatherElements on {data_rows}x{data_cols} data, axis={AXIS}")
...
model = helper.make_model(graph, producer_name="gather_elements_test", opset_imports=[helper.make_opsetid("", 11)])
model.ir_version = 7
